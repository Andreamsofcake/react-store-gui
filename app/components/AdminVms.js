...
class Admin_Vms extends Component {
  ...
  render() {
    return (
      <_E.Row class="vms">
        <_E.Col>
          <_E.Button onClick={this.heartBeatNow}>{Tranlate.translate('Admin_Vms''HeartBeatNow')}}</_E.Button>
          <_E.Button onClick={this.lastHeartbeatTime()}>{Translate.translate('Admin_Vms','LastHeartBeatTime')}</_E.Button>

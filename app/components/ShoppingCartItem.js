  ...
  render() {
    ...
    return (
      <_E.Row className="cart" className="shoppingCart">
			<_E.Col id="shopping-cart-image" sm="25%" md="15%" lg="15%" className="cart">

				<img src={prd.imagePath} /> {/*err-src="../Images/ProductImageNotFound.png"*/}

			</_E.Col>

			<_E.Col id="shopping-cart-table" xs="25%" sm="25%" md="25%" lg="25%" className="cart">{ prd.productName }</_E.Col>

			<_E.Col id="shopping-cart-table" xs="8%" sm="8%" md="8%" lg="8%" className="cart">{ TsvService.currencyFilter(prd.price * prd.qtyInCart) }</_E.Col>
			...
			<_E.Col xs="20%" sm="20%" md="20%" lg="20%" className="cart">
					...
					<_E.Row>
						...
						<_E.Col sm="1/3" id="shopping-cart-item"><_E.Button  type="primary" onClick={this.addQty.bind(null, prd.coilNumber)}><_E.Glyph icon="plus" /></_E.Button></_E.Col>
						{/*<img className="smallImg" src="../Images/minus.png" onClick={this.minusQty.bind(this, prd.coilNumber)}>*/}

						<_E.Col id="shopping-cart-item" sm="1/3">{ prd.qtyInCart}</_E.Col>

						<_E.Col sm="1/3" id="shopping-cart-item"><_E.Button id="shopping-cart-button" type="primary" onClick={this.minusQty.bind(null, prd.coilNumber)}><_E.Glyph icon="dash" /></_E.Button></_E.Col>

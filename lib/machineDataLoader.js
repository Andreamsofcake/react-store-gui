...
function getMachine(auth, id) {
  return new Promise(function(resolve, reject) {
    SDK.machineGetByVendorId(auth, { vendor_id: id }, function(error, res){
      if(error) {
        return reject(error)
      }
...
function getCategories(auth, categories) {
  return new Promise(function(resolve, reject) {
...
function retrieveUpdate(machineName, callback) {
  ...
  getMachine(auth, machineName).then(function(res) {
    ...
    getPlanogramByMachine(auth, data.machine._id).then(function(res) {
        ...
        getProductsByPlanogram(auth, productList).then(function(res) {
          res.data.items.forEach(function(prd){
            ...
            if (prd.categories.length) {
              ...
              getCategories(auth, categoryList).then(function(res){
